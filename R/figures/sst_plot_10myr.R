...
stage_vals <- read.csv("./results/SST/10myr_binned_vals.csv")
...
p1 <- ggplot() +
  ...
  geom_point(data = stage_vals, mapping=aes(x = myr10, y = temperature_stage), colour = "black", size = 1.1, alpha  = 1) +
  geom_line(data = stage_vals, mapping=aes(x = myr10, y = temperature_stage), colour = "black", size = 1.1, alpha  = 1) +
...
p2 <- ggplot() +
  ...
  geom_point(data = stage_vals, mapping=aes(x = myr10, y = ext_temperature_stage_modern), colour = "#0570b0", size = 1.1, alpha  = 1) +
  geom_line(data = stage_vals, mapping=aes(x = myr10, y = ext_temperature_stage_modern), colour = "#0570b0", size = 1.1, alpha  = 1) +
  scale_x_reverse(expand=c(0,0), limits = c(541, 0)) +
...
p3 <- ggplot() +
  ...
  geom_point(data = stage_vals, mapping=aes(x = myr10, y = ext_temperature_stage_eocene), colour = "#b10026", size = 1.1, alpha  = 1) +
  geom_line(data = stage_vals, mapping=aes(x = myr10, y = ext_temperature_stage_eocene), colour = "#b10026", size = 1.1, alpha  = 1) +
  scale_x_reverse(expand=c(0,0), limits = c(541, 0)) +
...
ggsave(file = "./figures/extracted_temperature_10myr.jpg", plot = plots, width = 200, height = 95, units = "mm", dpi = 300, scale = 1.75)
